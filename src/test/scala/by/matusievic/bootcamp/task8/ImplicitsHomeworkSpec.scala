...
import by.matusievic.bootcamp.task8.ImplicitsHomework.SuperVipCollections4s._
import by.matusievic.bootcamp.task8.ImplicitsHomework.SuperVipCollections4s.syntax._
import by.matusievic.bootcamp.task8.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import by.matusievic.bootcamp.task8.ImplicitsHomework.SuperVipCollections4s._
          |import by.matusievic.bootcamp.task8.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import by.matusievic.bootcamp.task8.ImplicitsHomework.MyTwitter._
